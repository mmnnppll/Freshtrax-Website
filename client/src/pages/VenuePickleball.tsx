...
const config: VenueConfig = {
  ...
  benefits: [
    {
      title: "Eliminates court contamination at the source",
      description: "UVC light and ozone treat shoes before players step on court, breaking the transmission cycle of fungi and bacteria between sessions.",
    },
    {
      title: "90-second self-service cycle",
      description: "No staff involvement. Members sanitize their own shoes before or after play. Works during warm-up, between games, or on the way out.",
    },
    {
      title: "Reduces athlete's foot complaints",
      description: "Tinea pedis spreads readily in shared court environments. Regular sanitization disrupts the cycle and reduces infection risk for your entire membership.",
    },
  ],
  stats: [
  ...
  operatorReasons: [
    ...
    },
    {
      ...
      description: "As pickleball clubs multiply, hygiene amenities are becoming a meaningful differentiator. Members notice — and mention it to friends.",
    },
    {
    ...
    },
    {
      ...
      description: "Freshtrax kiosks are designed for unattended operation. No refills to manage, no cleaning supplies to stock, no staff training required.",
    },
  ],
  faqs: [
    {
      q: "Where is the kiosk typically placed in a pickleball facility?",
      a: "Most clubs place the kiosk near the court entrance or in the lobby, so members can sanitize on the way in. Some facilities place it adjacent to the locker room.",
    },
    {
      q: "Does it work for all types of court shoes?",
      a: "Yes. The Freshtrax chamber accommodates standard athletic footwear including pickleball-specific court shoes, sneakers, and cross-trainers up to size 15.",
    },
    {
      q: "How much space does the kiosk require?",
      a: "The kiosk footprint is compact — approximately 24\" x 24\" — and can be positioned against a wall or in any open floor area near court access.",
    },
    {
      q: "How does revenue collection work for the venue?",
